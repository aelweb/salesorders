			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"OrderSales-display": {
								"semanticObject": "OrderSales",
								"action": "display",
								"description": "Sales Orders details",
								"title": "Order Sales",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.ordersales",
									"url": sap.ui.require.toUrl("com/sap/ordersales")
								}
							}
						}
					}
